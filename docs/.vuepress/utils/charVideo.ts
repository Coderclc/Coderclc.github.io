...
function CharVideo(config = defaultConfig) {
  ...
  this.width = Math.ceil((defaultConfig.width ?? window.innerWidth) / this.space)
  this.height = Math.ceil((defaultConfig.height ?? window.innerHeight) / this.space)
  this.data = {}
  this.cav = {}
  this.ctx = {}
